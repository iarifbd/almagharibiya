...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">almagharibiyaltd.com</a>
            <!-- Sidebar Toggle-->
        ...
        <script src="<?php echo base_url(); ?>assets/dashboard/assets/demo/chart-area-demo.js"></script>
        <script src="<?php echo base_url(); ?>assets/dashboard/assets/demo/chart-bar-demo.js"></script>
